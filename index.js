 ...
 */
function sagaPromiseWrapper(store) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, effects_1.call.apply(void 0, __spreadArrays([func, options, action], args.slice(0, args.length - 1)))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
...
exports.default = sagaPromiseWrapper;
